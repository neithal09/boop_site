              ...
              {teamMembers.map((member) => (
                ...
                >
                  <div className="team-card group relative bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:border-white/30 transition-all duration-500 hover:transform hover:scale-105">
                    {/* Image container */}
                    <div className="relative h-72 sm:h-80 md:h-80 lg:h-96 w-full aspect-[3/4] overflow-hidden bg-gray-900">
                      <img
                        src={member.image}
                        alt={member.name}
                        className="team-image w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-110"
                      />
